...
Route::group(['prefix' => 'panel','middleware' => 'auth'], function(){
    ...
    Route::group(['prefix' => 'wisata', 'as' => 'wisata.', 'middleware' => 'auth'], function() {
        Route::get('/', [WisataController::class, 'index'])->name('index');
        Route::get('/get-data', [WisataController::class, 'getData'])->name('getData');
        Route::post('/store', [WisataController::class, 'store'])->name('store');
        Route::get('/{wisata}', [WisataController::class, 'show'])->name('show');
        Route::post('/{wisata}/update', [WisataController::class, 'update'])->name('update');
        Route::post('/{wisata}/delete', [WisataController::class, 'delete'])->name('delete');
        Route::get('/{wisata}/detail', [WisataController::class, 'detail'])->name('detail');
    });
});
// Dashboard
